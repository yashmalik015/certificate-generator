...
async function processAll() {
  ...
  const templates = [
    {
      ...
      process: (canvas, ctx, baseImg) => {
        ...
        // 1. Clear top-left CIN (inside inner borders, untouched frame)
        ctx.fillStyle = '#fbfcec';
        ctx.fillRect(85, 65, 225, 65);

        // 2. Clear old logo & composite official IHREO logo
        ctx.fillRect(310, 44, 108, 94);
        ctx.drawImage(logoImg, 318, 44, 92, 92);

        // 3. Clear preprinted "International Business & Entrepreneurship,"
        ctx.fillRect(95, 680, 540, 30);

        // 4. Signatures
        ctx.drawImage(sigFounder, 110, 840, 130, 45);
        ctx.drawImage(sigCoFounder, 520, 840, 130, 45);
      }
    },
    {
      ...
      process: (canvas, ctx, baseImg) => {
        ...
        ctx.fillRect(75, 65, 215, 65);

        // 2. Clear old crest & composite official IHREO logo
        ctx.fillRect(300, 48, 115, 96);
        ctx.drawImage(logoImg, 310, 52, 94, 94);

        // 3. Signatures
        ctx.drawImage(sigFounder, 105, 835, 130, 45);
        ctx.drawImage(sigCoFounder, 475, 835, 130, 45);
      }
    },
    {
      ...
      process: (canvas, ctx, baseImg) => {
        ...
        // 4. Signatures
        ctx.drawImage(sigFounder, 110, 715, 130, 45);
        ctx.drawImage(sigCoFounder, 465, 715, 130, 45);
      }
    },
    {
      ...
      process: (canvas, ctx, baseImg) => {
        ...
        // 4. Signatures
        ctx.drawImage(sigFounder, 105, 845, 130, 45);
        ctx.drawImage(sigCoFounder, 455, 845, 130, 45);
      }
    },
    {
      ...
      process: (canvas, ctx, baseImg) => {
        ...
        // 3. Signatures
        ctx.drawImage(sigFounder, 100, 845, 130, 45);
        ctx.drawImage(sigCoFounder, 470, 845, 130, 45);
      }
    }
  ];
  ...
  for (const t of templates) {
    ...
    // Make single-page PDF with exact image dimensions
    ...
    console.log(`✓ Flawlessly processed template: ${t.name}`);
  }
}
